...
block_0:
  agam_str __v3 = "f\"Hello, {name}!\"";
  printf("%s", (agam_str)__v3);
  printf("\n");
  agam_int __v4 = 0;
  agam_int _local_scores = 0;
  agam_int __v5 = 0;
  agam_int __v10 = 0; /* unit */
  _local_scores = __v10;
  ...
  agam_int _local___iter_11 = 0;
  agam_int __v15 = 0;
  agam_int __v16 = 0; /* unit */
  _local___iter_11 = __v16;
  agam_int __v17 = __v16;
  goto block_1;
block_1:
  agam_int __v18 = _local___iter_11;
  agam_int __v19 = agam_has_next(__v18);
  if (__v19) goto block_2; else goto block_3;
block_2:
  agam_int _local_score = 0;
  agam_int __v20 = 0;
  agam_int __v21 = _local___iter_11;
  agam_int __v22 = agam_next(__v21);
  _local_score = __v22;
  agam_int __v23 = __v22;
  agam_int __v24 = _local_total;
  agam_int __v25 = _local_score;
...
block_3:
  ...
  agam_str __v35 = "f\"Average score: {avg}\"";
  printf("%s", (agam_str)__v35);
  printf("\n");
  agam_int __v36 = 0;
  agam_int __v37 = 0;
  return (int)__v37;
