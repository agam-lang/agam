# Phase T3-universal-ffi � Universal Foreign Function Interface
...
- Phase T0-type-system (type system) — generics for typed FFI wrappers
- Phase T2-memory-model (memory model) — ownership interop with foreign languages
- Phase T3-wasm-backend (WASM) — JavaScript/web interop
