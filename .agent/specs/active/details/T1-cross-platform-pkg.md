# Phase T1-cross-platform-pkg � Cross-Platform Packaging
...
- Phase T1-resolver-lockfile (lockfile) — extends existing lockfile infrastructure
- Phase T3-pkg-manager-maturity (package manager) — registry-side version preservation
- Phase T2-cybersecurity (security) — cryptographic signing shared infrastructure
