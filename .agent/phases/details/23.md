...
**Status:** partial (Basic NVPTX pipeline, fixed-size array GPU memory typing, host-device transfer helpers, and shared-memory lowering complete; advanced capabilities pending)
